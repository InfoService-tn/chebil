...
class AccountMove(models.Model):
    ...
    def get_xlsx_report(self, datas, response):
        ...
        sheet.write('A1', 'Numéro', txt )
        sheet.write('A2', 'Date' )
        sheet.write('A3', 'Nom du client' )
...
#            sheet.merge_range('B4:E4', company_name, txt)
            ...
            sheet.write ( row,1, account_move.name, txt )
            sheet.write ( row,2, invoice_date )
            sheet.write ( row,3, account_move.partner_id.name )
